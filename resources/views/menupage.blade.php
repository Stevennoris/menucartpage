...
@vite(['resources/js/app.js'])
    ...
    <section class="menu w-full flex">
     ...
     <div class="cardlist  bg-whitecream w-[72%] items-center justif-center flex flex-col gap-[50px] ">
         <div class="resto w-full h-[250px] bg-whitecream flex flex-col items-center">
             ...
             <div class="resto_rate bg-ijo h-[70px] flex w-[85%] rounded-[10px] items-center shadow-[1px_1px_1px_#666]" >
         ...
         <div class="card bg-abuabu w-[390px] h-[250px] rounded-[10px] shadow-[1px_1px_1px_#666]"></div>
         <div class="card bg-abuabu w-[390px] h-[250px] rounded-[10px] shadow-[1px_1px_1px_#666]"></div>
         <div class="card bg-abuabu w-[390px] h-[250px] rounded-[10px] shadow-[1px_1px_1px_#666]"></div>
         <div class="card bg-abuabu w-[390px] h-[250px] rounded-[10px] shadow-[1px_1px_1px_#666]"></div>
         <div class="card bg-abuabu w-[390px] h-[250px] rounded-[10px] shadow-[1px_1px_1px_#666]"></div>
         ...
         <!-- <button class="fixed right-0 top-[50vh] w-[50px] h-[80px] rounded-[100px_0_0_100px] bg-ijo text-white font-bold text-[20px] shadow-lg"onclick="buttonmenu()">cart</button> -->
     </div>

<!-- ini tandain flex ke hidden -->
     <div class="cart bg-abuabu flex
     flex-col h-[100vh] fixed items-center right-0 gap-30px  w-[28%]" >
         <div class="headercart sticky w-full  flex flex-col h-[15vh] border-b-4 border-[#00615F] ">
             ...
             <div class="carttitle w-full flex flex-col justify-center items-center  h-[60%] bg-abuabu">
                 <h1>CART</h1>
                 <h2>McDonald's, Sentul City</h2>
             </div>
         </div>

         <div class="cartmid w-[90%] bg-abuabu flex h-[70vh] flex-col gap-[2vh] overflow-y-auto overflow-x-hidden scrollbar-none " >
             <div class="cartmenulist flex bg-abuabu gap-[20px] h-[250px] items-center">
                 <div class="quantity w-[10%] inline-flex flex-col h-[100px] border-none justify-center items-center rounded-[8px] bg-ijo" >
                     <button class="h-[35px] bg-transparent" onclick="increment()">+</button>
                     <input class="w-[100%] text-center border-none pointer-events-none h-[30px] bg-transparent" type="text" id="number" value="1" readonly>
                     <button class="h-[35px] bg-transparent" onclick="decrement()">−</button>
                 </div>
                 <div class="picturemenu w-[100px] h-[100px] ">
                 </div>
                 <div class="descmenu">
...
//     menucard.classList.remove('w-full');
//     menucard.classList.add('w-[72%]');
...
//     menucard.classList.remove('w-[72%]');
//     menucard.classList.add('w-full');
